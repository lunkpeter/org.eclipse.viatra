...
/**
 * Interface, which represents a step in a transformation chain. These steps can implement various batch and
 * event-driven natured functionalities.
 * 
 * @author Peter Lunk
 *
 */
public interface ITransformationStep extends Runnable {
